...
python ${SCRIPTS_DIR}/filter_pair_realigns.py -i ${OUTPUT}.pairs.bam -a ${OUTPUT}.pair_anchors.sam -o ${OUTPUT}.pair_mei_hits -ao ${OUTPUT}.pair_anchor_hits -c ${OUTPUT}.clips_merged.bam &
...
# python ${SCRIPTS_DIR}/cluster.py -i <(vcf-sort ${OUTPUT}.vcf) > ${OUTPUT}.clusters.1.bed